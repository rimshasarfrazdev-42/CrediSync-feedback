    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-[520px] p-6 z-50">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={onClose} className="w-1/2 py-3">
            Keep Subscription
          </Button>

          <Button onClick={onConfirm} disabled={loading} className="w-1/2 py-3 text-white bg-[#EF4444] hover:bg-red-600">
