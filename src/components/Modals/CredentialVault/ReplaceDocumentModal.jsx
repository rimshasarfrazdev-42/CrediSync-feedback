      ...
      <div ref={modalRef} className="relative w-full max-w-xl bg-white border shadow-xl rounded-xl border-tertiary/20 ">
        ...
        <div className="px-6 pb-4 space-y-3">
          <div>
            ...
            <label className="flex flex-col items-center justify-center w-full transition border-2 border-dashed cursor-pointer border-tertiary/30 bg-tertiary/5 rounded-xl h-36 hover:bg-tertiary/10">
          ...
          <div className="flex gap-2 p-3 text-sm border rounded-md bg-primary/20 border-primary/50 text-primary">
        ...
        <div className="flex flex-col justify-end gap-3 px-4 pb-4 sm:flex-row">
          <button
            onClick={onClose}
            className="w-full px-4 py-2 text-gray-700 transition bg-gray-100 border rounded-md hover:bg-gray-200"
          >
            Cancel
          </button>
