...
function DeleteAccountContainer() {
  return (
    <div className="">
      <div className="grid w-full grid-cols-1 gap-6 p-4 mx-auto bg-white border sm:p-6 min-h-60 border-tertiary/15 rounded-b-xl lg:rounded-r-xl">
        ...
        {/* Warning Box */}
        <div className="w-full p-4 border sm:p-5 md:p-6 border-red-500/20 bg-[#EF4444]/10 rounded-xl">
          {/* Top warning row */}
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
            <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-[#EF4444] text-white rounded-[10px]">
              <TriangleAlert className="w-5 h-5" />
            </div>

            <div className="space-y-1">
              <p className="text-[15px] sm:text-[16px] md:text-[18px] font-medium text-[#EF4444]">
                Warning: Deactivating your account will restrict access.
              </p>
              <p className="text-[13px] sm:text-[14px] font-normal text-[#EF4444] leading-relaxed">
                Once deactivated, you will no longer be able to view, share, or verify your credential information
                within the vault.
              </p>
            </div>
          </div>
          ...
          <div className="w-full p-3 mt-5 bg-white border sm:p-4 md:p-5 sm:mt-6 border-red-500/40 rounded-xl">
            <h3 className="mb-3 text-[15px] sm:text-[16px] md:text-[18px] font-medium text-[#EF4444]">
          ...
          <div className="mt-5 sm:mt-6 w-full bg-white border border-red-500/40 rounded-[10px] p-3 sm:p-5 md:p-4 shadow-sm">
  ...
  "
              ...
              <span className="text-[13px] sm:text-[14px] md:text-[16px] lg:text-[17px] xl:text-[18px] font-medium text-[#C32727] leading-relaxed">
                I understand that my account will be deactivated, and I will lose access to my credential data and
                sharing capabilities until reactivated.
              </span>
            </label>
          </div>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="bg-[#EF4444] hover:bg-red-600 text-white font-semibold text-[14px] sm:text-[16px] rounded-md mt-6 sm:mt-8 w-full sm:w-auto">
            ...
            <DialogContent className="w-[92%] sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[40%] max-h-[70vh] overflow-y-auto rounded-[20px] p-5 sm:p-6 md:p-8">
              ...
              <section className="w-full mt-2">
                <p className="text-[14px] sm:text-[15px] md:text-[16px] text-tertiary leading-relaxed font-normal">
                  Are you sure you want to deactivate your CrediSync account? Once deactivated, you will lose access to
                  your credential vault, sharing, and verification features until you reactivate your account. Your data
                  will remain securely stored in accordance with CrediSync’s HIPAA and compliance policies.
                </p>
              </section>
