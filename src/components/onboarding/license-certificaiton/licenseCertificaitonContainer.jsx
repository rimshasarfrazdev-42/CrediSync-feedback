      ...
      <div className="grid w-full grid-cols-1 gap-6 mt-5">
        <div className="w-full mt-2 lg:p-5 lg:mt-5 lg:border rounded-3xl border-zinc-200">
          <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col">
              <p className="mb-2 text-base font-semibold text-secondary">
                Issuing State<span className="ml-1 text-red-500">*</span>
              </p>
              <Input
                placeholder="CA"
            ...
            <div className="flex flex-col">
              <p className="mb-2 text-base font-semibold text-secondary">
                Issue Date<span className="ml-1 text-red-500">*</span>
              </p>
          ...
          <div className="w-full mt-3">
            <div className="flex flex-col space-y-2">
              <p className="text-base font-semibold text-secondary">
                Upload License<span className="ml-1 text-red-500">*</span>
              </p>
              <div
              ...
              >
                <p
                  className={`truncate text-sm ${licenseRefs.uploadLicenseRef.current ? 'text-secondary' : 'text-gray-500'}`}
                >
        ...
        <div className="w-full p-5 border rounded-3xl border-zinc-200">
          <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col">
              ...
              <div className='relative'>
                ...
                />
                {(!licenseRefs.boardNameRef.current || licenseRefs.boardNameRef.current.length === 0) && (
                  <span className="absolute left-[15px] top-[9px] text-[15px] text-zinc-500 pointer-events-none max-w-[90%] overflow-hidden text-ellipsis whitespace-nowrap">American Board of Internal Medicine</span>
                )}
              </div>
          ...
          <div className="flex flex-col mt-3">
            <p className="mb-2 text-base font-semibold text-secondary">
              Upload Certificate<span className="ml-1 text-red-500">*</span>
            </p>
            <div
              className="flex items-center justify-between h-10 p-2 transition-colors border border-gray-200 rounded-md cursor-pointer hover:bg-gray-50"
            ...
            >
              <p
                className={`truncate text-sm ${licenseRefs.uploadCertificateRef.current ? 'text-secondary' : 'text-gray-500'}`}
              >
