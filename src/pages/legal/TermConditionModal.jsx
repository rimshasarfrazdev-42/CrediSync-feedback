    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center !mt-0" aria-modal="true" role="dialog">
      ...
      <div className="relative w-full max-w-7xl mx-3 sm:mx-4 bg-white rounded-2xl shadow-[0_18px_45px_rgba(15,27,61,0.25)] border border-[#e1e6f0] flex flex-col max-h-[90vh] ">
        ...
        <div className="px-6 pt-4 pb-2 overflow-y-auto text-[0.82rem] sm:text-[0.97rem] leading-relaxed text-slate-800 space-y-3">
          <p>
            By creating a CrediSync account, you agree to comply with our data-handling and credentialing policies
            outlined below. These Terms &amp; Conditions govern your use of the CrediSync Provider Portal and all
            related services.
          </p>

          <h3 className="mt-3 font-semibold text-slate-900">Agreement Overview</h3>
          <p>
            This agreement ("Agreement") is entered into between you ("Provider", "You", or "User") and CrediSync, Inc.
            ("CrediSync", "We", or "Us"). By accessing or using the CrediSync Provider Portal, you acknowledge that you
            have read, understood, and agree to be bound by these Terms &amp; Conditions.
          </p>
          <p>
            The CrediSync Provider Portal is a HIPAA and SOC 2–compliant healthcare credentialing platform designed to
            streamline the verification and management of healthcare provider credentials. Your use of this platform
            constitutes acceptance of these terms in their entirety.
          </p>

          <h3 className="mt-3 font-semibold text-slate-900">User Responsibilities</h3>
          <p>As a user of the CrediSync Provider Portal, you agree to:</p>
          <ul className="space-y-1 list-disc list-inside">
            <li>Provide accurate, current, and complete information during registration and credentialing processes</li>
            <li>
              Maintain the confidentiality of your account credentials and notify us immediately of any unauthorized
              access
            </li>
            <li>Use the platform solely for lawful purposes related to healthcare credentialing</li>
            <li>Comply with all applicable federal, state, and local laws, including HIPAA regulations</li>
            <li>Keep your professional licenses, certifications, and credentials current and valid</li>
            <li>Promptly update any changes to your personal or professional information</li>
            <li>Not share, sell, or transfer your account access to any third party</li>
          </ul>

          <h3 className="mt-3 font-semibold text-slate-900">Data Usage &amp; Security</h3>
          <p>
            CrediSync collects and processes personal and professional information necessary for healthcare
            credentialing purposes. This includes, but is not limited to:
          </p>
          <ul className="space-y-1 list-disc list-inside">
          ...
          <p className="mt-2">We implement industry-standard security measures to protect your data, including:</p>
          <ul className="space-y-1 list-disc list-inside">
