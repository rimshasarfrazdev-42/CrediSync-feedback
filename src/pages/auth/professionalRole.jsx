      ...
      <div className="flex items-center justify-center w-full px-4 border shadow-sm md:w-1/2 rounded-2xl">
        <div className="w-full p-6 bg-white">
          ...
          <p className="mb-6 text-center text-sm font-medium text-slate-900 sm:text-[20px]">
            Choose the designation that best matches your practice to tailor your
            onboarding.
          </p>
            ...
            {roles.map((role) => {
              ...
              return (
                <button
                  ...
                  className={`flex h-full flex-col justify-between rounded-lg border bg-white p-3 text-left transition-shadow focus:outline-none focus:ring-2 focus:ring-[#163B6D]/60 ${
                    isActive
                      ? "border-[#163B6D] bg-[#e8ebf5] shadow-md"
                      : "border-[#d7dde6] hover:shadow-sm"
                  }`}
                >
          ...
          <div className="flex items-start gap-2 mb-4">
            ...
            <p className="text-sm text-gray-500">
              Role selection helps tailor compliance steps; no PHI is shared.
            </p>
          </div>
