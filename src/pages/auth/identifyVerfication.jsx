...
const IdentityVerification = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // If validation is not true then form hide and box show
    if (!isValid) {
      setFormAppear(false)
  ...
  // When we click on retry then form show again to fill and remove manual box.
  const showFormhandler =()=>{
    setFormAppear(true)
    setShowAutoVerifyError(false)
  }
    ...
    <div className="flex h-screen gap-6 bg-white">
      ...
      <div className="flex items-center justify-center w-full px-4 py-8 border shadow-sm lg:w-1/2 rounded-2xl">
        <div className="w-full bg-white">
          {/* Heading */}
          <h1 className="mb-3 text-xl font-semibold text-center text-secondary sm:text-2xl">Identity Verification</h1>
          ...
          {showAutoVerifyError && (
            <div className="p-3 mb-4 text-[16px] text-gray-900 border border-gray-300 rounded-md bg-gray-100">
              <div className="flex gap-2">
                <span className="mt-[3px] shrink-0 text-base text-gray-500">
